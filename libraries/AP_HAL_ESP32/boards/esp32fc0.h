...
#define HAL_INS_PROBE_LIST PROBE_IMU_I2C(LSM9DS1, 0, 0x6A, ROTATION_ROLL_180_YAW_90)
...
#define HAL_ESP32_WIFI 2 // 2 use udp, 1 use tcp...  for udp,client needs to connect as UDPCL in missionplanner etc to 192.168.4.1 port 14550
#define WIFI_SSID "har-minimum"
#define WIFI_PWD "hondahar"
...
// RCIN on what pin?
#define HAL_ESP32_RCIN GPIO_NUM_35
...
#define HAL_ESP32_SDSPI                                                                                                 \
    {                                                                                                                   \
        .host = VSPI_HOST, .dma_ch = 1, .mosi = GPIO_NUM_23, .miso = GPIO_NUM_19, .sclk = GPIO_NUM_18, .cs = GPIO_NUM_5 \
    }
...
// this becomes the default value for the ardupilot param LOG_BACKEND_TYPE,
// which most ppl want to be 1, for log-to-flash
